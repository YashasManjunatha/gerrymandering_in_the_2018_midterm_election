...
#load in municipality shapefile
...
#ask if any municipality intersects two counties within a cluster 
#   report a potential problem if so
#   have checked by hand - only need to worry about wake forest
#   which allows for a hack: place all of Franklin in wake's township :)
