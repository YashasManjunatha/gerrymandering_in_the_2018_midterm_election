...
page = "https://ballotpedia.org/United_States_House_of_Representatives_elections,_2016"

driver = webdriver.Chrome('C:/Users/Mitra Kiciman/Documents/Downloads/chromedriver_win32/chromedriver.exe')
driver.implicitly_wait(30)
driver.get(page)

show_button = driver.find_element_by_id("collapseButton1")
show_button.click()

soup = BeautifulSoup(driver.page_source, 'lxml')
results = soup.find(id="collapsibleTable1")
output = []
outFile = 'C:/Users/Mitra Kiciman/Documents/gerrymanderingimpact/2016_elections_margins.csv'
